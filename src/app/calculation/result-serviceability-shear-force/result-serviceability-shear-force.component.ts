        ...
        for (const position of member.positions) {
          for (const side of ["上側引張", "下側引張"]) {
            ...
            const resultColumn: any = this.getResultString(
              this.calc.calcSigma(resultData, position)
            );
