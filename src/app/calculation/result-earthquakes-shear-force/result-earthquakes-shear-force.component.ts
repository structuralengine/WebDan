...
@Component({
  ...
  templateUrl: './result-earthquakes-shear-force.component.html',
...
export class ResultEarthquakesShearForceComponent implements OnInit {
  ...
  constructor(private http: Http,
    private print: CalcEarthquakesShearForceService,
  ...
  private setPages(response: string, postData: any): boolean {
    ...
    this.earthquakesShearForcePages = this.print.setEarthquakesPages(json, postData);
    return true;
  }
