...
export class CalcEarthquakesShearForceService {
  ...
  public setDesignForces(isPrintOut: boolean): any[] {
    ...
    const DesignForce = this.force.getDesignForceList('ShearForce', this.save.basic.pickup_shear_force_no[7]);
  ...
  public getPostData(): any {
    ...
    // POST 用
    const postData = this.post.getPostData(this.DesignForceList, 4, 'ShearForce', '耐力', 1);
    return postData;
  }
