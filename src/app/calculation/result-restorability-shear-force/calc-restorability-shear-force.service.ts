...
export class CalcRestorabilityShearForceService {
  ...
  public setDesignForces(isPrintOut: boolean): any[] {
    ...
    pickupNoList.push(this.save.basic.pickup_shear_force_no[6]); // ピックアップNoは せん断の6番目に保存されている
  ...
  public getPostData(): any {
    ...
    const postData = this.post.getPostData(this.DesignForceList, 3, 'ShearForce');
    return postData;
  }
