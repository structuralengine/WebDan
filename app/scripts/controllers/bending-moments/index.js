...
angular.module('webdan')
  .controller('BendingMomentsIndexCtrl', function ($scope, $log, BendingMoment) {
    let ctrl = this;
    ...
    function init() {
      ...
      BendingMoment.$queryAsc().then(function(bendingMoments) {
        ctrl.bendingMoments = bendingMoments;
      });
    }
