...
angular.module('webdan').controller('LoginCtrl', ['$scope', 'Auth', '$location', '$q', 'Ref', '$timeout', function ($scope, Auth, $location, $q, Ref, $timeout) {
  ...
  $scope.passwordLogin = function (email, pass) {
    $scope.err = null;
    Auth.$signInWithPassword({ email: email, password: pass }, { rememberMe: true }).then(redirect, showError);
  };
